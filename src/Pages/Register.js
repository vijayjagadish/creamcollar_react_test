        ...
        axios
            ...
            .then((response) => {
                ...
                axios
                    ...
                    .catch((error) => {
                        window.alert('EmailId is Already Registered')
    ...
    <div class="container">
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div class="form-group">
                ...
                <input type="number" id="currentSemester" name="currentSemester" placeholder="Enter your current semester" value={formData.currentSemester} onChange={handleInputChange} required/>
            </div>
